...
#        my $sp = $1, if($info[8]=~/ID=([A-Z]+)-\w+;/);
    #    my $sp = $1, if($info[8]=~/ID=([^-]+)-\w+;/);
...
#        print "$info[0]\t$down[0]\t$info[8]\t$down[8]\n";
